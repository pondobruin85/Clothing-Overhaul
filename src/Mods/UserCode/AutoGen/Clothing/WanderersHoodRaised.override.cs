...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "WanderersHoodRaised" clothing item. 
    /// </para>
    ...
    [LocDisplayName("Wanderers Hood Raised")] // Defines the localized name of the item.
    [LocDescription("A quality linen cowl raised, hiding your face partially.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the WanderersHoodRaised is.
    [Tag("Clothes")]
