...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "ShipwrightShirt" clothing item. 
    /// </para>
    ...
    [LocDisplayName("Shipwright Shirt")] // Defines the localized name of the item.
    [LocDescription("A striped shirt symbolizing your affinity for traveling across the seas.")] //The tooltip description for this clothing item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ShipwrightShirt".</para>
    ...
    public partial class ShipwrightShirtRecipe : RecipeFamily
    {
        public ShipwrightShirtRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ShipwrightShirt",  //noloc
                displayName: Localizer.DoStr("Shipwright Shirt"),
                ...
                {
                    new CraftingElement<ShipwrightShirtItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Shipwright Shirt"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Shipwright Shirt"), recipeType: typeof(ShipwrightShirtRecipe));
