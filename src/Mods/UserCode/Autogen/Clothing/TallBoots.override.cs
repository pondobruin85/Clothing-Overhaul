...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "TallBoots" clothing item. 
    /// </para>
    ...
    public partial class TallBootsRecipe : RecipeFamily
    {
        public TallBootsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "TallBoots",  //noloc
                displayName: Localizer.DoStr("Tall Boots"),
            ...
            this.Initialize(displayText: Localizer.DoStr("Tall Boots"), recipeType: typeof(TallBootsRecipe));
