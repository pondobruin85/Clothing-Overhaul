...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "Trousers" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Trousers".</para>
    ...
    public partial class TrousersRecipe : RecipeFamily
    {
        public TrousersRecipe()
        {
            ...
            recipe.Init(
                name: "Trousers",  //noloc
                displayName: Localizer.DoStr("Trousers"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Trousers"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Trousers"), recipeType: typeof(TrousersRecipe));
