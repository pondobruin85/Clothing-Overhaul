...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "BuilderOveralls" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BuilderOveralls".</para>
    ...
    public partial class BuilderOverallsRecipe : RecipeFamily
    {
        public BuilderOverallsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "BuilderOveralls",  //noloc
                displayName: Localizer.DoStr("Builder Overalls"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(NylonFabricItem), 40, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<BuilderOverallsItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Builder Overalls"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Builder Overalls"), recipeType: typeof(BuilderOverallsRecipe));
