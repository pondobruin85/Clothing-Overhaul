...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "SmithBandana" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SmithBandana".</para>
    ...
    public partial class SmithBandanaRecipe : RecipeFamily
    {
        public SmithBandanaRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SmithBandana",  //noloc
                displayName: Localizer.DoStr("Smith Bandana"),
                ...
                {
                    new CraftingElement<SmithBandanaItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Smith Bandana"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Smith Bandana"), recipeType: typeof(SmithBandanaRecipe));
