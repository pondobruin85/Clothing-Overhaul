...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "Sandals" clothing item. 
    /// </para>
    ...
    [LocDisplayName("Sandals")] // Defines the localized name of the item.
    [LocDescription("Basic footwear that helps reduce the strain of walking longer distances.\n\n(Decreases calories consumed when using tools by 10\u0025)")] //The tooltip description for this clothing item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Sandals".</para>
    ...
    public partial class SandalsRecipe : RecipeFamily
    {
        public SandalsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Sandals",  //noloc
                displayName: Localizer.DoStr("Sandals"),
                ...
                {
                    new CraftingElement<SandalsItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Sandals"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Sandals"), recipeType: typeof(SandalsRecipe));
