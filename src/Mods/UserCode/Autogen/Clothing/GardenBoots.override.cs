...
namespace Eco.Mods.TechTree
{
        ...
        ClothingItem , IClothingOverhaulBlockMovespeedDictionary
    {
        ...
        public Dictionary<Type, float> BlockMovespeedModifiers { get; } = new Dictionary<Type, float>()
        {
            ...
            { typeof(DirtRoadBlock),               4.0f },  //  Dirt Road Blocks            
            { typeof(StoneRoadCubeBlock),          4.5f },  //  Stone Roads    
    ...
    public partial class GardenBootsRecipe : RecipeFamily
    {
        public GardenBootsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "GardenBoots",  //noloc
                displayName: Localizer.DoStr("Garden Boots"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(FurPeltItem), 3, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Garden Boots"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Garden Boots"), recipeType: typeof(GardenBootsRecipe));
