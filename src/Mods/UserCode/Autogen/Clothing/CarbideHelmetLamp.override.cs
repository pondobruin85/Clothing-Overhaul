...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "CarbideHelmetLamp" clothing item. 
    /// </para>
    ...
    [LocDescription("A steel hardhat with a light source for the darkest places.\n\n(Flashlight)")] //The tooltip description for this clothing item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CarbideHelmetLamp".</para>
    ...
    public partial class CarbideHelmetLampRecipe : RecipeFamily
    {
        public CarbideHelmetLampRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CarbideHelmetLamp",  //noloc
                displayName: Localizer.DoStr("Carbide Helmet Lamp"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(BasicCircuitItem), 5, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                ...
                {
                    new CraftingElement<CarbideHelmetLampItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Carbide Helmet Lamp"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Carbide Helmet Lamp"), recipeType: typeof(CarbideHelmetLampRecipe));
