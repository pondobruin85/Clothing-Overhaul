...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "TailorShoes" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TailorShoes".</para>
    ...
    public partial class TailorShoesRecipe : RecipeFamily
    {
        public TailorShoesRecipe()
        {
            ...
            recipe.Init(
                name: "TailorShoes",  //noloc
                displayName: Localizer.DoStr("Tailor Shoes"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(SyntheticRubberItem), 4, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<TailorShoesItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Tailor Shoes"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Tailor Shoes"), recipeType: typeof(TailorShoesRecipe));
