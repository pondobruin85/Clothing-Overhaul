...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "ChefHat" clothing item. 
    /// </para>
    ...
    [LocDescription("To keep your hair in one place while stirring the pots.")] //The tooltip description for this clothing item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ChefHat".</para>
    ...
    public partial class ChefHatRecipe : RecipeFamily
    {
        public ChefHatRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ChefHat",  //noloc
                displayName: Localizer.DoStr("Chef Hat"),
                ...
                {
                    new CraftingElement<ChefHatItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Chef Hat"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Chef Hat"), recipeType: typeof(ChefHatRecipe));
