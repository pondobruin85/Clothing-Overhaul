...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "RunningShoes" clothing item. 
    /// </para>
    ...
    public partial class RunningShoesItem : ClothingItem, IClothingOverhaulBlockMovespeedDictionary
    {
        ...
        public Dictionary<Type, float> BlockMovespeedModifiers { get; } = new Dictionary<Type, float>()
        {
            ...
            { typeof(DirtBlock),                   4.0f },  //  Dirt Blocks                                                            
            { typeof(BasaltBlock),                 4.0f },  //  Solid Rock Type Blocks      
            ...
            { typeof(CrushedBasaltBlock),          4.0f },  //  Crushed Type Blocks            
            { typeof(ClayBlock),                   3.5f },  //  Clay Blocks            
            { typeof(SandBlock),                   3.0f },  //  Sand Blocks   
            { typeof(CottonCarpetBlock),           3.5f },  //  Carpet Blocks
    ...
    /// <summary>
    /// <para>Server side recipe definition for "RunningShoes".</para>
    ...
    public partial class RunningShoesRecipe : RecipeFamily
    {
        public RunningShoesRecipe()
        {
            ...
            recipe.Init(
                name: "RunningShoes",  //noloc
                displayName: Localizer.DoStr("Running Shoes"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(OilPaintItem), 2, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Running Shoes"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Running Shoes"), recipeType: typeof(RunningShoesRecipe));
