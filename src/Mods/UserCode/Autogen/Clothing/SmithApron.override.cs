...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "SmithApron" clothing item. 
    /// </para>
        ...
        ClothingItem
    {
        ...
        public override string Slot                     { get { return AvatarAppearanceSlots.Waist; } }
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SmithApron".</para>
    ...
    public partial class SmithApronRecipe : RecipeFamily
    {
        public SmithApronRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SmithApron",  //noloc
                displayName: Localizer.DoStr("Smith Apron"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(IronBarItem), 2, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<SmithApronItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Smith Apron"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Smith Apron"), recipeType: typeof(SmithApronRecipe));
