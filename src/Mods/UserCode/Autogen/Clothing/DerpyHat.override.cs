...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "DerpyHat" clothing item. 
    /// </para>
    ...
    public partial class DerpyHatRecipe : RecipeFamily
    {
        public DerpyHatRecipe()
        {
            ...
            recipe.Init(
                name: "DerpyHat",  //noloc
                displayName: Localizer.DoStr("Derpy Hat"),
            ...
            this.Initialize(displayText: Localizer.DoStr("Derpy Hat"), recipeType: typeof(DerpyHatRecipe));
