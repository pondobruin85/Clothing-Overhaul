...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "ExplorerPants" clothing item. 
    /// </para>
    ...
    [LocDescription("Reinforced pants for exploring but still be fashionable.")] //The tooltip description for this clothing item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ExplorerPants".</para>
    ...
    public partial class ExplorerPantsRecipe : RecipeFamily
    {
        public ExplorerPantsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ExplorerPants",  //noloc
                displayName: Localizer.DoStr("Explorer Pants"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(CottonFabricItem), 30, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<ExplorerPantsItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Explorer Pants"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Explorer Pants"), recipeType: typeof(ExplorerPantsRecipe));
