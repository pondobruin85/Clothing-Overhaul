...
{
    public class ModifierDynamicValue : IDynamicValue
    {
        public float GetBaseValue => 0f;
        public ref int ControllerID => ref id;
        private int id;
        public IModifierFunction ClothingModifierFunction { get; }

        public ModifierDynamicValue(IModifierFunction clothingOverhaulModifierFunction)
        {
