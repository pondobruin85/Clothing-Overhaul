...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "ClothBelt" clothing item. 
    /// </para>
    ...
    [LocDisplayName("Cloth Belt")] // Defines the localized name of the item.
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ClothBelt".</para>
    ...
    public partial class ClothBeltRecipe : RecipeFamily
    {
        public ClothBeltRecipe()
        {
            ...
            recipe.Init(
                name: "ClothBelt",  //noloc
                displayName: Localizer.DoStr("Cloth Belt"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Fabric", 2, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)), //noloc
                },
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Cloth Belt"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Cloth Belt"), recipeType: typeof(ClothBeltRecipe));
