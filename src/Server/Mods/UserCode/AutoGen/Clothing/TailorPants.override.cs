...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "TailorPants" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TailorPants".</para>
    ...
    public partial class TailorPantsRecipe : RecipeFamily
    {
        public TailorPantsRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<TailorPantsItem>()
                });
