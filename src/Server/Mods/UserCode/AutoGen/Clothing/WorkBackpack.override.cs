...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "WorkBackpack" clothing item. 
    /// </para>
        ...
        ClothingItem
    {
        ...
        {
            { UserStatType.MaxCarryWeight, 8000 },
    ...
    /// <summary>
    /// <para>Server side recipe definition for "WorkBackpack".</para>
    ...
    public partial class WorkBackpackRecipe : RecipeFamily
    {
        public WorkBackpackRecipe()
        {
            ...
            recipe.Init(
                name: "WorkBackpack",  //noloc
                displayName: Localizer.DoStr("Work Backpack"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(BoardItem), 2, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Work Backpack"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Work Backpack"), recipeType: typeof(WorkBackpackRecipe));
