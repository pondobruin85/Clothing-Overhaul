...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "WanderersHoodLowered" clothing item. 
    /// </para>
    ...
    [LocDisplayName("Wanderers Hood Lowered")] // Defines the localized name of the item.
    [LocDescription("A quality linen cowl lowered, showing your face.")] //The tooltip description for this clothing item.
    [StartsDiscovered] // Tells the server this item starts discovered when a new server is made.
    [Weight(100)] // Defines how heavy the WanderersHoodLowered is.
    [Tag("Clothes")]
    [Tag("Clothing - Head")]
