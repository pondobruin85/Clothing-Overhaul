...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "ExplorerHat" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ExplorerHat".</para>
    ...
    public partial class ExplorerHatRecipe : RecipeFamily
    {
        public ExplorerHatRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ExplorerHat",  //noloc
                displayName: Localizer.DoStr("Explorer Hat"),
                ...
                {
                    new CraftingElement<ExplorerHatItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Explorer Hat"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Explorer Hat"), recipeType: typeof(ExplorerHatRecipe));
