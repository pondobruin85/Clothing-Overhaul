...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "OilHeadLamp" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "OilHeadLamp".</para>
    ...
    public partial class OilHeadLampRecipe : RecipeFamily
    {
        public OilHeadLampRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "OilHeadLamp",  //noloc
                displayName: Localizer.DoStr("Oil Head Lamp"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(SteelPlateItem), 1, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                    ...
                    new IngredientElement(typeof(TorchItem), 1, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                },
                ...
                {
                    new CraftingElement<OilHeadLampItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Oil Head Lamp"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Oil Head Lamp"), recipeType: typeof(OilHeadLampRecipe));
