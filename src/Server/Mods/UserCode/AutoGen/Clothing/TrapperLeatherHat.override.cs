...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "TrapperLeatherHat" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "DerpyHat".</para>
    ...
    public partial class TrapperLeatherHatRecipe : RecipeFamily
    {
        public TrapperLeatherHatRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Trapper Leather Hat",  //noloc
                displayName: Localizer.DoStr("Trapper Leather Hat"),
                ...
                {
                    new CraftingElement<TrapperLeatherHatItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Derpy Hat"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Trapper Leather Hat"), recipeType: typeof(TrapperLeatherHatRecipe));
