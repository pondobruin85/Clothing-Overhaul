...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "Bearpack" clothing item. 
    /// </para>
    ...
    [LocDisplayName("Bearpack")] // Defines the localized name of the item.
        ...
        ClothingItem
    {
        ...
        {
            { UserStatType.MaxCarryWeight, 12000 },            
        };
    ...
    /// <summary>
    /// <para>Server side recipe definition for "Bearpack".</para>
    ...
    public partial class BearpackRecipe : RecipeFamily
    {
        public BearpackRecipe()
        {
            ...
            recipe.Init(
                name: "Bearpack",  //noloc
                displayName: Localizer.DoStr("Bearpack"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(CompositeLumberItem), 1, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Bearpack"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Bearpack"), recipeType: typeof(BearpackRecipe));
