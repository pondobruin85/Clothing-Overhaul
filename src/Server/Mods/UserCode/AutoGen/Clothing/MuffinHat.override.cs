...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "MuffinHat" clothing item. 
    /// </para>
    ...
    public partial class MuffinHatRecipe : RecipeFamily
    {
        public MuffinHatRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Muffin Hat",  //noloc
                displayName: Localizer.DoStr("Muffin Hat"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(FruitMuffinItem), 1, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                ...
                {
                    new CraftingElement<MuffinHatItem>()
                });
            ...
            this.Initialize(displayText: Localizer.DoStr("Muffin Hat"), recipeType: typeof(MuffinHatRecipe));
