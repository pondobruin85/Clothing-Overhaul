...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "SmithGloves" clothing item. 
    /// </para>
        ...
        ClothingItem
    {
        ...
        {
            { UserStatType.MaxCarryWeight, 6000 },
        };
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SmithGloves".</para>
    ...
    public partial class SmithGlovesRecipe : RecipeFamily
    {
        public SmithGlovesRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<SmithGlovesItem>()
                });
