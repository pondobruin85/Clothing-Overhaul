...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "CamoShirt" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CamoShirt".</para>
    ...
    public partial class CamoShirtRecipe : RecipeFamily
    {
        public CamoShirtRecipe()
        {
            ...
            recipe.Init(
                name: "CamoShirt",  //noloc
                displayName: Localizer.DoStr("Camo Shirt"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Camo Shirt"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Camo Shirt"), recipeType: typeof(CamoShirtRecipe));
