...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "ShipwrightOveralls" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "ShipwrightOveralls".</para>
    ...
    public partial class ShipwrightOverallsRecipe : RecipeFamily
    {
        public ShipwrightOverallsRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<ShipwrightOverallsItem>()
                });
