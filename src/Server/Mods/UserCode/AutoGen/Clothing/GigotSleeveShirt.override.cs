...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "GigotSleeveShirt" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "GigotSleeveShirt".</para>
    ...
    public partial class GigotSleeveShirtRecipe : RecipeFamily
    {
        public GigotSleeveShirtRecipe()
        {
            ...
            recipe.Init(
                name: "GigotSleeveShirt",  //noloc
                displayName: Localizer.DoStr("Gigot Sleeve Shirt"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Gigot Sleeve Shirt"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Gigot Sleeve Shirt"), recipeType: typeof(GigotSleeveShirtRecipe));
