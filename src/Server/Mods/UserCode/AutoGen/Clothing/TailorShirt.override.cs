...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "TailorShirt" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "TailorShirt".</para>
    ...
    public partial class TailorShirtRecipe : RecipeFamily
    {
        public TailorShirtRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new CraftingElement<TailorShirtItem>()
                });
