...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "TrapperFurHat" clothing item. 
    /// </para>
    ...
    public partial class TrapperFurHatRecipe : RecipeFamily
    {
        public TrapperFurHatRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Trapper Fur Hat",  //noloc
                displayName: Localizer.DoStr("Trapper Fur Hat"),
                ...
                {
                    new CraftingElement<TrapperFurHatItem>()
                });
            ...
            this.Initialize(displayText: Localizer.DoStr("Trapper Fur Hat"), recipeType: typeof(TrapperFurHatRecipe));
