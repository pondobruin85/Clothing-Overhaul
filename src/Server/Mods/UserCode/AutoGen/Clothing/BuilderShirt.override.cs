...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "BuilderShirt" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "BuilderShirt".</para>
    ...
    public partial class BuilderShirtRecipe : RecipeFamily
    {
        public BuilderShirtRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "BuilderShirt",  //noloc
                displayName: Localizer.DoStr("Builder Shirt"),
                ...
                {
                    new CraftingElement<BuilderShirtItem>()
                });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Builder Shirt"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Builder Shirt"), recipeType: typeof(BuilderShirtRecipe));
