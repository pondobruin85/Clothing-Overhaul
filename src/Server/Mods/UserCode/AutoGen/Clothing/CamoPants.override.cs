...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "CamoPants" clothing item. 
    /// </para>
    ...
    [LocDisplayName("Camo Pants")] // Defines the localized name of the item.
    ...
    [Weight(100)] // Defines how heavy the CamoPants is.
    [Tag("Clothes")]
    ...
    /// <summary>
    /// <para>Server side recipe definition for "CamoPants".</para>
    ...
    public partial class CamoPantsRecipe : RecipeFamily
    {
        public CamoPantsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "CamoPants",  //noloc
                displayName: Localizer.DoStr("Camo Pants"),
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Camo Pants"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Camo Pants"), recipeType: typeof(CamoPantsRecipe));
