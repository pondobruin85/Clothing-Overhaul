...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side item definition for the "SquareBelt" clothing item. 
    /// </para>
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SquareBelt".</para>
    ...
    public partial class SquareBeltRecipe : RecipeFamily
    {
        public SquareBeltRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SquareBelt",  //noloc
                displayName: Localizer.DoStr("Square Belt"),
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(CopperPlateItem), 1, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
                },
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Square Belt"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Square Belt"), recipeType: typeof(SquareBeltRecipe));
